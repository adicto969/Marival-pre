...
function Checadas(){
    ...
    if(fecha1 != '' && fecha2 != '' && Periodo != '' && tipoNom != ''){
        variables = 'periodo='+Periodo+'&fecha1='+fecha1+'&fecha2='+fecha2+'&tipoNom='+tipoNom+'&obtenDiasAnt=false&cantidadXpagina='+cantidadXpagina+'&pagina='+pagina+'&order='+ordenar+'&buscar='+busqueda+'&centroE='+centroE;
        $.ajax({
          beforeSend: function() {
