...
if(empty($row)){
  $numCc = 1;
  $SnumC = 1;
  $consult = "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'destajo'";
  ...
  $INSERT = "INSERT INTO destajo VALUES('$codigo', '".date("Y")."', '$PC', '$IDEmpresa', '$centro', ".substr($complemento, 0, -1).");";
}else {
  $INSERT = "UPDATE destajo SET ".$Columna." = '$valor' WHERE Codigo = '$codigo' AND Periodo = '$PC' AND IDEmpresa = '$IDEmpresa' AND Centro = '$centro';";
}
echo $INSERT;
